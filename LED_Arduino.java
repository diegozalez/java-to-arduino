...
public class LED_Arduino extends JFrame {
	...
	private String PUERTO="/dev/cu.wchusbserial1410";
	...
	public LED_Arduino() {
		...
		comboBox.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				PUERTO=port.get(comboBox.getSelectedIndex());
				...
				try {
					...
					mostrarError(i.getMessage()+" Consola abierta?");
					System.exit(ERROR);
				}
		...
		JButton sec25a32 = new JButton("Selct 25-32");
		sec25a32.setForeground(Color.black);
		sec25a32.setBounds(210, 285, 90, 40);
		sec25a32.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			for (int a = 0; a < 7; a++) {
				if(selcc.get(a).isSelected()){
					for (int j = 24; j < 32; j++) {
		...
		btnRainbow.setBounds(130, 125, 80, 40);
